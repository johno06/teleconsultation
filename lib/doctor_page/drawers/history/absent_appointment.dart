...
class AbsentAppointment extends StatefulWidget {
  const AbsentAppointment({Key? key}) : super(key: key);


  @override
  _AbsentAppointmentState createState() => _AbsentAppointmentState();
}

class _AbsentAppointmentState extends State<AbsentAppointment> {
...
// class HistoryScreen extends StatelessWidget {
  ...
  void fetchAppointments() async {
    const url = 'https://newserverobgyn.herokuapp.com/api/user/get-absent-appointments';
