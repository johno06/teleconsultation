...
class PatientApprovedScheduleCard extends StatelessWidget {
  dynamic _bgColor;
  ...
  PatientApprovedScheduleCard(this.patientName, this.patientSurname, this.patientPhone, this.patientEmail, this.bookingToday, this.bookingTime, this.date,
