...
class PatientAppointmentScheduleCard extends StatelessWidget {
  dynamic _bgColor;
      ...
      onTap: () {
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) =>
            // PendingDetailScreen(),
            ApprovedDetailScreen(patientName, patientSurname, patientPhone, patientEmail, bookingToday, bookingTime, date, appointmentId, consultationType, patientDevice),
          ),
        );
      },
      child: DecoratedBox(
        ...
        child: Padding(
          ...
          child: ListTile(
            ...
            subtitle: Text(
              'Consultation Type: $consultationType\nApproved: $patientName $patientSurname \n$bookingToday . $bookingTime',
              style: TextStyle(
